...
rfm_normalized.to_excel('rfm_normalized.xlsx',index=False)
...
rfm_l_normalized.to_excel('rfm_l_normalized.xlsx',index=False)
...
rfm_grp_normalized.to_excel('rfm_grp_normalized.xlsx',index=False)
...
rfml_grp_normalized.to_excel('rfml_grp_normalized.xlsx',index=False)
